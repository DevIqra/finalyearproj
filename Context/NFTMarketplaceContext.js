...
export const NFTMarketplaceProvider = ({ children }) => {
  const titleData = "Discover, collect, and sell Fashion NFTs ";
  ...
  const checkIfWalletConnected = async () => {
    try {
      if (!window.ethereum) return console.log("Install ");
  ...
  const uploadToIPFS = async (file) => {
    try {
      ...
      const url =" ipfs://bafybeihmgna226r6oimcq75cfzjnaujyaemzuilmy32miquzvk6d74hj4i"; // for dema & learning purpose only
      return url;
    } catch (error) {
